    ...
    [
      ...
      ({
        docs: {
          ...
          //editUrl:
          //  'https://github.com/josele03/AppTFG2.0',
        },
        blog: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'GitHub',
                href: 'https://github.com/josele03/AppTFG2.0',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} Mi Trabajo de Fin de Grado, Inc. Built with Docusaurus.`,
      },
      prism: {
